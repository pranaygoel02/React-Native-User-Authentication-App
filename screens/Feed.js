    ...
    <View style={{ flex: 1, alignItems: "center", paddingHorizontal: 8 }}>
      ...
      >
        ...
        >
          ...
          <TextInput
            style={{ marginHorizontal: 4, width: "100%" }}
            value={search}
            onChangeText={(text) => setSearch((prev) => text)}
            placeholder="Search by query title/tags..."
          />
        </View>
        <View
          style={{
        ...
        >
          <Text style={{ fontSize: 16 }}>
            {newest ? <Text>Latest</Text> : <Text>Oldest</Text>}
          </Text>
          <TouchableOpacity
            onPress={() => {
              setNewest((prev) => !prev);
            }}
            style={{ elevation: 2, padding: 2, shadowColor: "black" }}
          >
            <MaterialIcons
      ...
      <View>
        <TouchableOpacity
          ...
          style={{
            ...
            left: 130,
            zIndex: 1,
            backgroundColor: " rgb(25, 134, 214)",
            borderRadius: 100,
            padding: 18,
          }}
        >
