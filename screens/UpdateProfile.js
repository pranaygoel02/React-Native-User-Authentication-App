...
import uploadImage from "../utils/uploadImageToFb";
      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
        ...
        >
          ...
          >
            ...
            <View
              style={[styles.inputField, { marginBottom: 4, flexWrap: "wrap" }]}
            >
            ...
            <View style={styles.buttons}>
              <TouchableOpacity
                onPress={() => {
                  if (
                    !(
                      usernames.includes(username) && username !== user.username
                    ) ||
                    name !== user.name ||
                    email !== user.email ||
                    phoneNumber !== user.phoneNumber
            ...
            {open && (
              <View
                style={{
                  ...
                  marginBottom: 16,
                  borderRadius: 16,
                  backgroundColor: "rgba(240,245,255,0.995)",
                  elevation: 5,
                  shadowOffset: 10,
                  shadowRadius: 300,
                  shadowColor: "rgba(240,245,255,0.8)",
                  alignItems: "center",
                  justifyContent: "space-evenly",
                }}
              >
