...
const Post = ({navigation}) => {
  ...
  return (
    <SafeAreaView
      style={[
        open && { paddingBottom: 70 },
        { paddingTop: 16, paddingHorizontal: 8, flex: 1 },
      ]}
    >
      <ScrollView>
        ...
        <TouchableOpacity
          onPress={() => {
            if (username === post.author) handlePostOpen();
          }}
          style={[
            open ? styles1.open : styles1.closed,
            {
              padding: 8,
              marginVertical: 4,
          ...
          >
            <TouchableOpacity onPress={handlePostVote}>
              <MaterialCommunityIcons
                name={vote ? "thumb-up" : "thumb-up-outline"}
                size={20}
                color={"green"}
              />
            </TouchableOpacity>
        ...
        >
          <Text style={[styles.header, { fontSize: 24, marginVertical: 8 }]}>
            Comments
          </Text>
          <TouchableOpacity
            onPress={() => {
          ...
          >
            <MaterialIcons
              name={newest ? "arrow-circle-up" : "arrow-circle-down"}
              size={24}
              color={"#000"}
            />
          </TouchableOpacity>
      ...
      {open && (
        ...
        >
          <TextInput
            ...
            style={[styles.input_post, { width: "95%" }]}
          />
          <TouchableOpacity
            onPress={() => {
